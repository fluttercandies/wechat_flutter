...
class _AddFriendPageState extends State<AddFriendPage> {
  ...
  Widget body() {
    List data = [
      {'icon': '', 'title': '雷达加朋友', 'label': '添加身边的朋友'},
      {'icon': '', 'title': '面对面建群', 'label': '与身边的朋友进入同一个群聊'},
      {'icon': '', 'title': '扫一扫', 'label': '扫描二维码名片'},
      {'icon': '', 'title': '手机联系人', 'label': '添加或邀请通讯录中的朋友'},
      {'icon': '', 'title': '公众号', 'label': '获取更多资讯和服务'},
      {'icon': '', 'title': '企业微信联系人', 'label': '通过手机号搜索企业微信用户'},
    ];
    var content = [
      new SearchMainView(
        text: '微信号/手机号',
    ...
    return WillPopScope(
      child: new Scaffold(
        ...
        appBar: new ComMomBar(
          leadingW: isSearch ? learding : null,
          title: '添加朋友',
